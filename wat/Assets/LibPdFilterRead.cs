...
public class LibPdFilterRead : MonoBehaviour
{
	...
	void Update()	{
		...
		//LibPD.SendList("matrix_x", new float[5] {0,1,-1,1,-1} );
		//LibPD.SendList("wg_params", new float[2] {10, 0.5f});
		//LibPD.SendList ("testing", new float[2] {10,0.5f});
		//print ("sending");
		//LibPD.SendFloat ("testing2", 0.1f);
